...
function M.get(c)
  return {
    ...
    BlinkCmpKindConstant = { fg = c.green },
    BlinkCmpKindStruct = { fg = c.green_muted },
    ...
    MiniIndentscopeSymbol = { fg = c.blue_dark },
